...
class ExtractedPreferences(BaseModel):
    categories: List[str] = Field(default=[], description="Extracted keywords from user text")
    ingredients: List[str] = Field(default=[], description="Extracted keywords from user text")
